...
import com.example.cse299project.Model.Cart;
import com.example.cse299project.Prevalent.Prevalent;
import com.example.cse299project.ViewHolder.CartViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Intent intent = new Intent(CartActivity.this, ConfirmFinalProductActivity.class);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                if(snapshot.exists())
                {
                    ...
                    if(shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("Congratulations, Your order has been shipped. Soon you will receive your order");
